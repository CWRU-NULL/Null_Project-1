...
//snapshot for check-ins
  database.ref().on('value', function(snapshot){
    ...
    initialize(snapshot.val().bar1.checks);
  });
...
function initialize(pinChecks) {
  ...
  var pinIcon = "assets/Images/marker_blackA.png";

  if (pinChecks >= 20) {
    pinIcon = "assets/Images/marker_redA.png";
  }
  else if ((pinChecks >= 10) && (pinChecks <20)){
    pinIcon = "assets/Images/marker_orangeA.png";
  }
  else if ((pinChecks >= 5) && (pinChecks <10)){
    pinIcon = "assets/Images/marker_greenA.png";
  }
  else if ((pinChecks >= 1) && (pinChecks <5)){
    pinIcon = "assets/Images/marker_purpleA.png";
  }
  else{
    pinIcon = "assets/Images/marker_blackA.png";
  }
